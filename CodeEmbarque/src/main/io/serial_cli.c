...
const clicmd_t cmdTable[] = {
    ...
    CLI_COMMAND_DEF("dump", "dump configuration", "[master|profile|rates]", cliDump),
...
const clivalue_t valueTable[] = {
    ...
    { "align_board_roll",           VAR_INT16  | MASTER_VALUE, .config.minmax = { -180,  360 } , PG_BOARD_ALIGNMENT_ID, offsetof(boardAlignment_t, rollDegrees)},
    { "align_board_pitch",          VAR_INT16  | MASTER_VALUE, .config.minmax = { -180,  360 } , PG_BOARD_ALIGNMENT_ID, offsetof(boardAlignment_t, pitchDegrees)},
    { "align_board_yaw",            VAR_INT16  | MASTER_VALUE, .config.minmax = { -180,  360 } , PG_BOARD_ALIGNMENT_ID, offsetof(boardAlignment_t, yawDegrees)},
    ...
    { "failsafe_delay",             VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0,  200 } , PG_FAILSAFE_CONFIG_ID, offsetof(TYP_failsafe_config, failsafe_delay)},
    { "failsafe_off_delay",         VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0,  200 } , PG_FAILSAFE_CONFIG_ID, offsetof(TYP_failsafe_config, failsafe_off_delay)},
    { "failsafe_throttle",          VAR_UINT16 | MASTER_VALUE, .config.minmax = { PWM_RANGE_MIN,  PWM_RANGE_MAX } , PG_FAILSAFE_CONFIG_ID, offsetof(TYP_failsafe_config, failsafe_throttle)},
    { "failsafe_kill_switch",       VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , PG_FAILSAFE_CONFIG_ID, offsetof(TYP_failsafe_config, failsafe_kill_switch)},
    { "failsafe_throttle_low_delay",VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0,  300 } , PG_FAILSAFE_CONFIG_ID, offsetof(TYP_failsafe_config, failsafe_throttle_low_delay)},
    { "failsafe_procedure",         VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0,  1 } , PG_FAILSAFE_CONFIG_ID, offsetof(TYP_failsafe_config, failsafe_procedure)},
    ...
    #ifdef GTUNE
      { "gtune_loP_rll",              VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 10,  200 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_lolimP[FD_ROLL])},
      { "gtune_loP_ptch",             VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 10,  200 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_lolimP[FD_PITCH])},
      { "gtune_loP_yw",               VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 10,  200 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_lolimP[FD_YAW])},
      { "gtune_hiP_rll",              VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0,  200 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_hilimP[FD_ROLL])},
      { "gtune_hiP_ptch",             VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0,  200 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_hilimP[FD_PITCH])},
      { "gtune_hiP_yw",               VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0,  200 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_hilimP[FD_YAW])},
      { "gtune_pwr",                  VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0,  10 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_pwr)},
      { "gtune_settle_time",          VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 200,  1000 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_settle_time)},
      { "gtune_average_cycles",       VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 8,  128 } , PG_GTUNE_CONFIG_ID, offsetof(TYP_gtune_config, gtune_average_cycles)},
    #endif //GTUNE
...
static void cliVersion(char *cmdline)
{
    cliPrintf("# Cleanflight/%s %s %s / %s (Version 01_00)",
        targetName,
        FC_VERSION_STRING,
        buildDate,
        buildTime
