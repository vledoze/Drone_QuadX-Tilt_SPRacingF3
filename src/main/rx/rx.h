...
#define RX_FAILSAFE_MODE_COUNT 3  // 3 Modes "Failsafe" possibles
...
#define RX_FAILSAFE_TYPE_COUNT 2  // 3 Types "Failsafe" possibles
...
// -- Alias de pointeur de fonction : permet de déclarer une fonction comme un type de fonction
